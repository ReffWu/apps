(() => {
  ...
  const COMMON = {
    ...
    "home.sub": {"en": "Small, careful tools. Free, open source and notarized.", "zh-Hans": "小而用心的工具。免费、开源，经过 Apple 公证。", "zh-Hant": "小而用心的工具。免費、開源，經過 Apple 公證。", "ja": "小さく、丁寧な道具。無料・オープンソース・公証済み。", "ko": "작고 세심한 도구. 무료, 오픈 소스, 공증 완료.", "fr": "De petits outils soignés. Gratuits, open source et notarisés.", "es": "Herramientas pequeñas y cuidadas. Gratis, de código abierto y notarizadas.", "it": "Piccoli strumenti curati. Gratis, open source e notarizzati.", "tr": "Küçük, özenli araçlar. Ücretsiz, açık kaynak ve onaylı.", "pl": "Małe, dopracowane narzędzia. Darmowe, open source i notaryzowane.", "nl": "Kleine, zorgvuldige tools. Gratis, open source en genotariseerd."}
  };
